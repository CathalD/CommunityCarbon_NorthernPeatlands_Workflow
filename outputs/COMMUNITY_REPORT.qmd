...
Maps are supplied as GeoTIFF files in `outputs/spatial/`, ready to open in ArcGIS, QGIS or Google Earth Engine. Each carries a label stating what it is and what depth it refers to; `MANIFEST.csv` and `MANIFEST_bayes.csv` list them.
