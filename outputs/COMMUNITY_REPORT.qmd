...
All maps are GeoTIFF files that open directly in ArcGIS, QGIS or Google Earth Engine. Everything is written to a local folder in this project (`outputs/spatial/` and `outputs/gee/`), so nothing depends on a cloud account to open.
